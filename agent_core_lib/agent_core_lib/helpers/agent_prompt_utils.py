...
def repository_scope_text(task, prepared_task=None) -> str:
    ...
    for repository in repositories:
        ...
        repository_lines.append(
            ...
            'You may also use "git stash" to set uncommitted work aside and "git stash pop" to '
            'bring it back, "git apply" to apply a patch, and "git reflog" to find a commit that '
            'seems lost. '
